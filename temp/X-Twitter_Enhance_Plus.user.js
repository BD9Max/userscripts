...
// @author BD9Max
// @description Display images & videos in HD, Download button for media, Tweak thumbnails cropping in posts, Change feeds width
...
async function setupToggles(sidePanel)
{
    ...
    settingsFold.innerText = "X-Twitter Enhance+ Settings:";
    ...
    createToggleOption(sidePanel, toggleHQImg, "HD Images: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleHQVideo, "HD Videos: ", "ON", "OFF");
