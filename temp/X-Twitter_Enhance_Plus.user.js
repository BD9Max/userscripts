...
// Function for Greasemonkey to use
...
//Intercept the Timeline to pre-cache information about posts and filter out unwanted posts
            ...
            if (toggleHQVideo.enabled && thisRef.readyState === 4)
            {
                try {
                    ...
                    if(vidInfo != null && vidInfo.variants != null && vidInfo.variants.length > 2)
                    {
                        ...
                        Object.defineProperty(thisRef, 'response', { writable: true, value: JSON.stringify(json) });
                        Object.defineProperty(thisRef, 'responseText', { writable: true, value: JSON.stringify(json) });
                    }
                } catch (error) {
...
class Tweet
{
    constructor(tweetResult)
    {
        ...
        this.url = "https://x.com/" + this.username + "/" + this.id;
...
async function loadToggleValues()
{
    ...
    await Promise.allSettled([
        ...
        (async() => { toggleLiked = await getToggleObj("thd_toggleLiked", false) })(),
        ...
        (async() => { toggleTimelineScaling = await getToggleObj("thd_toggleTimelineScaling", false) })(),
        (async() => { toggleAnalyticsDisplay = await getToggleObj("thd_toggleAnalyticsDisplay", true) })(),
        (async() => { toggleDisableForYou = await getToggleObj("thd_toggleDisableForYou", false) })(),
        (async() => { toggleMakeLinksVX = await getToggleObj("thd_makeLinksVX", false) })()
    ]);
...
async function setupToggles(sidePanel)
{
    ...
    settingsFold.innerText = "X Enhance+ Settings:";
    ...
    createToggleOption(sidePanel, toggleNSFW, "Blur NSFW: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleHQImg, "HQ Images: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleHQVideo, "HQ Videos: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleTimelineScaling, "Timeline Width Scale: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleMakeLinksVX, "Use VX In Links: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleLiked, "Liked posts: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleFollowed, "Followed By Posts: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleRetweet, "Reposts: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleTopics, "Topic Posts: ", "ON", "OFF");
    createToggleOption(sidePanel, toggleClearTopics, "Interests/Topics AutoClear: ", "ON", "OFF");
